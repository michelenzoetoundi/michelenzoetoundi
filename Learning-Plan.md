...
|---------|----------------|----------------------|
| 1 | Mathematical Foundations 🟦 | Linear algebra, differential & integral calculus, linear programming, analytical thinking |
| 2 | Statistics & Probability 📊 | Descriptive statistics, inference, probability distributions, hypothesis testing, ANOVA |
| 3 | Data Science Tools 🟩 | R, Python, SQL, data wrangling, visualization, mini-projects, data cleaning & pipelines |
| 4 | Machine Learning 🤖 | Classical ML models: regression, SVM, Random Forest, clustering, model evaluation |
