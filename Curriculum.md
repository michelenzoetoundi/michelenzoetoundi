...
- Application projects: optimization, matrices, linear systems  
...
**✅ Practical Deliverables:**
- Real dataset analysis: SuperMarket, Telco, Bank  
- Documentation in Obsidian  
- Notebooks published on GitHub / Kaggle  
...
- SQL mini-projects: reporting, dashboards  
- Medium projects: full data cleaning & analysis pipeline  
...
**✅ Practical Deliverables:**
- Kaggle / GitHub projects: Telco churn, SuperMarket regression  
...
**✅ Practical Deliverables:**
- Medium projects: VGG-Face, simple chatbot, text/image generation  
- Documentation on Obsidian + GitHub notebooks  
...
- 🟢 Medium projects: full pipelines, ML & DL models on real datasets  
- 🟢 Complete projects: “Full Data Scientist” mini-projects (analysis, modeling, reporting, visualization)  
- 📂 Documentation: Obsidian, GitHub, Kaggle  
...
### 💡 Overall Methodology
1. 📖 **Theory** → read chapters and understand concepts  
2. 📝 **Exercises** → immediate consolidation  
3. 💻 **Projects** → small → medium  
4. 📂 **Documentation** → Obsidian for tracking and synthesis  
5. 🌐 **Versioning / Sharing** → GitHub / Kaggle for feedback & visibility  
